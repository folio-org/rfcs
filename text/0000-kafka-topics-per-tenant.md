...
- **Cost**: Kafka's use in FOLIO is still limited, more FOLIO modules will continue to employ event driven techniques that will cause an explosion of partitions. Adding more brokers to service the load compounded by partitions will mean increased costs.
