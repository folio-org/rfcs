...
- A Burst of messages from one tenant will inhibit processing of messages from other tenants to some degree compared to current state without this RFC's changes.
