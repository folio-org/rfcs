...
* In the forked repo on GitHub, create a PR comparing the branch where edited file is located to the master branch of the official RFC repo. Ensure the name of the pull request has the name of the RFC phase at the beginning. e.g. "[PRELIMINARY REVIEW] Java 17" or "PRELIMINARY REVIEW | Java 17". This will prepare your draft for preliminary review. Full instructions for preparing PRs for each stage of the RFC process are in the branching guide: https://wiki.folio.org/display/TC/RFC+Branching+Guide
